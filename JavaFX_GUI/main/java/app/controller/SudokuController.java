					...
					public void handle(DragEvent event) {
						...
						if (db.hasContent(myFormat)) {
							...
							if (!s.isValidValue(CellTo.getiRow(), CellTo.getiCol(), CellFrom.getiCellValue())) {
								...
								//when you place an invalid cell value, it increments mistakes
							...
							//updates the latinsquare array with the CellFrom iCellValue
							//and updates number of zeroes in the puzzle (to determine when the puzzle is complete)
							//and checks to see if you've maxed out your mistakes 
