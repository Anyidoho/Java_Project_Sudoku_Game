...
public class Sudoku extends LatinSquare implements Serializable {
	...
	public int countZeros()
	{
		...
		//System.out.println("there are " + iZeros + " zeros ");
		...
		if (iZeros <= 0)
		{
			...
			{
				System.out.println("The puzzle has errors. Go back and fix them!");
			}
		}
	...
	public void mistakesMaxed()
	{
		if (iMistakes >= this.eGameDifficulty.getiMaxMistakes())
		{
			System.out.println("Sorry, the max number of mistakes is " + this.eGameDifficulty.getiMaxMistakes()
			+ ", you lose.");
		}
	}
